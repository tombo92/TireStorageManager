...
def _phase1d_backup(base: str) -> None:
    ...
    # CSV export
    code, body = _get(base, "/backups/export")
    _check("GET /backups/export -> 200", code == 200, f"got {code}")
    _check(
...
def phase4_installer_upgrade(
    ...
    # Copy current app EXE into the install dir to simulate a version bump
    # (in real CI the dist/ folder already contains the new build)
